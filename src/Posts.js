...
const Posts = () => {
    ...
    const Postbtnclick =()=>{
        ...
        if(postBody && moodState){
            ...
            alert("please choose Emogi according to your mood!")
        }
    }
...
<div className=' '>
            <div className='flex justify-center items-center gap-4 mood-emogies'>
                ...
                <button id="mood-3" className='mood-emogi-btn hover:scale-125'>
                    <img src={thumb} alt="thumb" className='w-[76px]'/>
                    <h1>Good</h1>
                </button>
    ...
    <div className='flex flex-col m-2 p-2 justify-center items-center'>
        <textarea  value={post} placeholder='Enter about your Day!' onChange={(e)=>{
            setPost(e.target.value);
        }} className='border border-black w-96'/>
        
        
        <button type="submit" onClick={Postbtnclick} className='bg-black text-white font-serif m-2 p-2 rounded-md w-72 '> click to Post</button>
    </div>
